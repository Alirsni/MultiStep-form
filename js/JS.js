...
//     $(".step-1").removeClass("row");
//     $(".step-2").addClass("row");
//     $("#prev-button").addClass("display-show")
// });
...
//     $(".step-1").addClass("row");
//     $("#prev-button").removeClass("display-show");
// });
...
function showPreviousSection() {
	...
	// Wrap around to the last section if the index becomes negative
	...
	function showNextSection() {
		...
		// Wrap around to the first section if the index exceeds the number of sections
		...
		// Show the initial section (section at index 0)
		sections[currentSectionIndex].style.display = "none";
		
///////////////////////////////////////////////////////////////////////

// step-four city and states 
